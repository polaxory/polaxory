...
1. Add `docs/slices/FACTORY_SLICE_0_ACCEPTANCE.md`.
...
3. Ask Claude Code to implement one slice at a time from acceptance docs.
4. Ask Nullsec bot to watch CI and large-diff risk.
...
`docs: define factory slice 0 acceptance criteria`
